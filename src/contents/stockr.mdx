---
author: Soof Golan
datetime: 2022-03-09T19:11:25+02:00
...
ogImage: /assets/blog/stockr/cover.avif
description: stockr - a webapp that monitors live trades and quotes
---

![stockr](/assets/blog/stockr/cover.avif)
...
and wait for the response. Once authenticated, you can subscribe to specific and get callbacks for every update.

I believe a saner way to authenticate would be something like passing the authentication using
URL parameters [(which are secure)](https://stackoverflow.com/questions/499591/are-https-urls-encrypted):
